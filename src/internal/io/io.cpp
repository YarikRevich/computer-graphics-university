...
// readFileCGUOptimalNativeBW, readFileCGUOptimalNativeRGB
...
// SDL_Surface* IO::readFileCGU(std::string path, IO::FileMetadata* metadata) {
...
// IO::FileMetadata* IO::readMetadataFromFileCGU(std::ifstream* inputStream) {
...
// std::ofstream& IO::openWriteFileCGU(std::string path) {
//     //  file(path, std::ios_base::out | std::ios_base::binary);

//     return std::ofstream(path, std::ios_base::out | std::ios_base::binary);
// }

// std::ifstream& IO::openReadFileCGU(std::string path) {
//     std::ifstream file(path, std::ios_base::binary);

//     return file;
// }

// int IO::saveWriteFileCGU(std::ofstream& stream) {
//     stream.close();

//     return EXIT_SUCCESS;
// }

// int IO::closeReadFileCGU(std::ifstream& stream) {
//     stream.close();
